...
function FaqListItem({ question, answer,isOpen,onClick }){
  ...
  return (
    <div className="overflow-hidden">
      <div className="w-full  hover:bg-gray-50 dark:hover:bg-gray-700  rounded-lg  transition-colors flex items-center">
        <button
          onClick={onClick}
          className="flex py-5 justify-between  border-b border-gray-100 dark:border-gray-700  px-4  items-center w-full  "
        >
