...
<div className="py-6 px-4 sm:px-6 lg:px-8 ">
  <div className="max-w-3xl mx-auto">
    <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-700 shadow-md rounded-2xl p-6 space-y-6 transition-colors">
      ...
      {notification && (
        <div className={`p-3 rounded-lg flex items-center text-sm font-medium ${
          notification.isSuccess 
            ? 'bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-300'
            : 'bg-red-100 dark:bg-red-900 text-red-800 dark:text-red-300'
        }`}>
          {notification.isSuccess ? <CheckCircleIcon className="w-5 h-5 mr-2" /> : <XCircleIcon className="w-5 h-5 mr-2" />}
      ...
      <form  onSubmit={handleSubmit} className="space-y-5 ">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <div>
            <label htmlFor="quantity" className="block text-sm mb-1 text-zinc-600 dark:text-zinc-400">Quantity*</label>
            <input
              id="quantity"
              name="quantity"
              type="number"
        ...
        <div>
          <span className="block text-sm mb-1 text-zinc-600 dark:text-zinc-400">Transaction Type*</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          <div>
            <label htmlFor="date" className="block text-sm mb-1 text-zinc-600 dark:text-zinc-400">Date*</label>
        ...
        <div>
          <label htmlFor="description" className="block text-sm mb-1 text-zinc-600 dark:text-zinc-400">Description</label>
          <textarea
            id="description"
            name="description"
